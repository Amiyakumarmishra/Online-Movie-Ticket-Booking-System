...
public class BookMyShow {
    ...
    public void createBooking(City userCity, String movieName) {
        ...
        List<Movie> movies = movieController.getAllMoviesByCity(userCity);
    ...
    private void createTheatre() {
        ...
        theatreController.addTheater(inoxTheatre, City.Banglore);
        theatreController.addTheater(pvrTheatre, City.Delhi);
